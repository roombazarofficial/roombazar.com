    ...
    <div className="max-w-2xl">
      ...
      {log && (
        <>
          ...
          <dl className="mt-6 grid grid-cols-2 gap-4 rounded-control border border-line bg-surface p-4 text-sm">
            ...
            />
            <Row
              label="Recipients (devices)"
              value={String(log.recipientCount)}
            />
          ...
          {log.recipients.length > 0 && (
            <div className="mt-6">
              ...
              <ul className="mt-2 divide-y divide-line rounded-control border border-line bg-surface text-sm">
