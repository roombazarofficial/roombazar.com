...
/**
 * New-message alerts cannot be turned off entirely. A lister who misses
 * enquiries looks unresponsive and the seeker gives up — that failure hurts
 * both sides and the marketplace, so the channel is a choice but the alert
 * itself is not.
 */
