      ...
      <div className="flex gap-4">
        ...
        {coverPhoto ? (
          <Link
            ...
            className="group relative size-20 sm:size-24 shrink-0 overflow-hidden rounded-xl border border-line bg-surface-muted"
          >
          ...
          <div className="flex size-20 sm:size-24 shrink-0 items-center justify-center rounded-xl border border-line bg-surface-muted text-xs text-ink-muted">
            No Photo
          </div>
        )}
        ...
        <div className="min-w-0 flex-1">
          <div className="flex flex-wrap items-start justify-between gap-2">
            <div className="min-w-0">
              <Link
                href={routes.myListing(listing.id)}
                className="text-sm sm:text-base font-semibold text-ink hover:text-brand-700 hover:underline"
              >
                {listing.title}
              </Link>
